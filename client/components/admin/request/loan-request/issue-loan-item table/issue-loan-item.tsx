...
import { PlusIcon } from "../loan-request tables/PlusIcon";

import { VerticalDotsIcon } from "../loan-request tables/VerticalDotsIcon";
import { ChevronDownIcon } from "../loan-request tables/ChevronDownIcon";
import { SearchIcon } from "../loan-request tables/SearchIcon";

import { capitalize } from "../loan-request tables/utils"; 
...
export const IssueLoanItemTable = ({requestedQuantity, data, selectedItemId}) => {
...
},
{
  ...
  const issueRequest = async (requestId, userId) => {
    ...
    try {
      console.log("post:", selectedStocks)
