...
import { IssueUserItemTable } from "@/components/storekeeper/request/user-request/issue-user-item table/issue-user-item";
  ...
  return (
    <div className="my-14 lg:px-6 max-w-[95rem] mx-auto w-full flex flex-col gap-4">
      <div className="flex w-full flex-col">
        ...
        <Card>
          <CardBody>
            <IssueUserItemTable requestedQuantity={requestData && requestData.count} data={requestData && requestData} selectedItemId={requestData && (requestData.item_id && requestData.item_id._id)}/>
          </CardBody>
        </Card>
      </div>
        
